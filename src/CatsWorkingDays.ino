...
void loop() {
  ...
  switch (currentState) {
    ...
    // ---------------- МЕНЮ ----------------
    case STATE_MENU:
      arduboy.setCursor(8, 8);   arduboy.print("CAT'S WORKING DAYS");
      arduboy.drawBitmap(64 - CAT_W/2, 26, catSprite, CAT_W, CAT_H, WHITE);
      arduboy.setCursor(14, 50); arduboy.print("A: Start");
      arduboy.setCursor(14, 58); arduboy.print("B: Controls");
    ...
    case STATE_GAMEPLAY: {
      ...
      switch (shieldDir) {
        case DIR_UP:    arduboy.drawFastHLine(CAT_CX - 16, CAT_CY - 20, 32, WHITE); break;
        case DIR_DOWN:  arduboy.drawFastHLine(CAT_CX - 16, CAT_CY + 20, 32, WHITE); break;
        case DIR_LEFT:  arduboy.drawFastVLine(CAT_CX - 20, CAT_CY - 16, 32, WHITE); break;
        case DIR_RIGHT: arduboy.drawFastVLine(CAT_CX + 20, CAT_CY - 16, 32, WHITE); break;
      }
      ...
      // HUD
      arduboy.setCursor(2, 4);   arduboy.print("HP:");  arduboy.print(hp);
